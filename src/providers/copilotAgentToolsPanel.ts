...
export class CopilotAgentToolsPanel {
    public static currentPanel: CopilotAgentToolsPanel | undefined;
    ...
    public static createOrShow(extensionUri: vscode.Uri) {
        const column = vscode.window.activeTextEditor
            ...
            : undefined;        if (CopilotAgentToolsPanel.currentPanel) {
            CopilotAgentToolsPanel.currentPanel._panel.reveal(column);
            return;
        ...
        CopilotAgentToolsPanel.currentPanel = new CopilotAgentToolsPanel(panel, extensionUri);
    }
    ...
    private constructor(
        ...
        CopilotAgentToolsPanel.currentPanel = undefined;
        this._panel.dispose();
  ...
  /* Bot Message Colors */
  --copilot-bot-message-bg: ${effectiveColors.botMessageBackground};
  --copilot-bot-message-text: ${effectiveColors.botMessageText};
  --copilot-bot-message-border: ${effectiveColors.botMessageBorder};
  
  /* User Message Colors */
  --copilot-user-message-bg: ${effectiveColors.userMessageBackground};
  --copilot-user-message-text: ${effectiveColors.userMessageText};
  --copilot-user-message-border: ${effectiveColors.userMessageBorder};
  
  /* Chat Interface Colors */
  --copilot-chat-bg: ${effectiveColors.chatBackground};
  --copilot-chat-border: ${effectiveColors.chatBorder};
  --copilot-chat-shadow: ${effectiveColors.chatShadow};
  
  /* Input Area Colors */
  --copilot-input-bg: ${effectiveColors.inputBackground};
  --copilot-input-text: ${effectiveColors.inputText};
  --copilot-input-border: ${effectiveColors.inputBorder};
  --copilot-input-placeholder: ${effectiveColors.inputPlaceholder};
  
  /* Button Colors */
  --copilot-primary-btn-bg: ${effectiveColors.primaryButtonBackground};
  --copilot-primary-btn-text: ${effectiveColors.primaryButtonText};
  --copilot-primary-btn-border: ${effectiveColors.primaryButtonBorder};
  --copilot-secondary-btn-bg: ${effectiveColors.secondaryButtonBackground};
  --copilot-secondary-btn-text: ${effectiveColors.secondaryButtonText};
  --copilot-secondary-btn-border: ${effectiveColors.secondaryButtonBorder};
  
  /* Accent Colors */
  --copilot-accent-color: ${effectiveColors.accentColor};
  --copilot-link-color: ${effectiveColors.linkColor};
  --copilot-error-color: ${effectiveColors.errorColor};
  --copilot-success-color: ${effectiveColors.successColor};
  --copilot-warning-color: ${effectiveColors.warningColor};
}`;
    ...
    private async _handleJsonExport(json: any, formattedJson: string) {
        ...
        try {
            ...
            <head>
                ...
                <meta http-equiv="Content-Security-Policy" content="default-src 'none'; style-src ${cspSource} 'unsafe-inline'; script-src ${cspSource} 'unsafe-inline' 'unsafe-eval'; font-src ${cspSource}; img-src ${cspSource} data: https:; connect-src ${cspSource} https: wss: ws:; media-src ${cspSource} https:; frame-src 'none'; object-src 'none'; base-uri 'none';">
