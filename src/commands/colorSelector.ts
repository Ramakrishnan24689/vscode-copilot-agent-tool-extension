...
import { ColorPickerPanel } from '../providers/colorPickerPanel';
import { HTMLGenerator } from '../utils/htmlGenerator';

export class ColorSelectorCommand {
    constructor(
    ...
    async openThemeGallery(): Promise<void> {
        try {
            ColorPickerPanel.createOrShow(this.extensionUri);
            vscode.window.showInformationMessage('🤖 Copilot Agent Tools opened! Select a theme and see the live preview.');
        } catch (error) {
